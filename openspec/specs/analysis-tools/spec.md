...
Cada execução de tool DEVE possuir timeout, retry limitado (máx. 2) e registro de log estruturado com trace_id; falha após os retries DEVE ser registrada sem interromper a análise.
